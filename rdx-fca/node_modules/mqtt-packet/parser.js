...
class Parser extends EventEmitter {
  ...
  _parseHeader () {
    ...
    if (requiredHeaderFlags != null && headerFlags !== requiredHeaderFlags) {
      // Facebook sends PUBACK and other ack packets with non-standard header flag bits.
      // Skip the strict check for those packet types to avoid disconnections.
      const facebookNonStrictTypes = [4, 5, 7, 9, 11]
      if (!facebookNonStrictTypes.includes(cmdIndex)) {
