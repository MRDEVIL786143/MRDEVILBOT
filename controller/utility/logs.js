...
const printBanner = () => {
  ...
  process.stdout.write(chalk.hex('#FF6B6B').bold(' ║  ★ MR DEVIL BOT ★   ║\n'));
  ...
  process.stdout.write('\n');
  process.stdout.write(chalk.green(' Dev   : ') + chalk.white.bold('MR DEVIL\n'));
  process.stdout.write(chalk.green(' WA    : ') + chalk.white.bold('+923301068874\n'));
  process.stdout.write(chalk.green(' Email : ') + chalk.white.bold('mrdevilbot@gmail.com\n'));
  process.stdout.write('\n');
};
